...
Async client to interact with the ETG hotel booking API.
Uses httpx.AsyncClient for HTTP requests with Basic Authentication.
...
class ETGClient:
    ...
    async def search_hotels_by_region(  # noqa: PLR0913
        self,
        region_id: int,
        checkin: str,
        checkout: str,
        ...
        Args:
            ...
            residency: Guest residency country code (ISO 3166-1 alpha-2).
            guests: List of room configurations with adults/children.
            currency: Price currency code (ISO 4217).
            language: Response language code (ISO 639-1).
            hotels_limit: Maximum number of hotels in response.
        ...
        payload: dict[str, Any] = {
            ...
            "checkout": checkout,
            "residency": residency,
            "guests": _normalize_guests(guests),
        }
        if currency:
